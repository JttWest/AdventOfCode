...
with open('./input.txt') as fp:
  ...
  movement = {'left': -1, 'right': 1, 'neutral': 0}

  joystick_pos = 'neutral'
  paddle_pos = (0,0)
  ball_pos = (0,0)


  while True:
    x = program.excute([movement[joystick_pos]])
    y = program.excute([movement[joystick_pos]])
    data = program.excute([movement[joystick_pos]])
